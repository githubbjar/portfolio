...
//for creating the objects
    ...
    //add the projects
    //SALVO
    $allProjects[] = new FullProject("#41 / Summer '17 / 64 pages", "<em>Salvo</em> magazine", "images/sv41/", "cover.jpg", "old-mag-ad.jpg", "eye-openers", 6, "its-beyond-us", 5, "timing-is-everything", 4, "improbably-so", 2);
    $allProjects[] = new FullProject("#64 / Spring '23 / 64 pages", "<em>Salvo</em> magazine", "images/sv64/", "cover.jpg", "blog-ad.jpg", "ingenious-ants", 4, "cannot-compute", 4, "new-eyes", 4, "mind-your-mind", 3);
    ...
    $allProjects[] = new FullProject("#51 / Winter '19 / 48 pages", "<em>Salvo</em> magazine", "images/sv51/", "cover.jpg", "blog-ad.jpg", "who-made-whom", 3, "planetary-jewel", 5, "thinning-margins", 4, "going-to-pot", 2);
    ...
    $allProjects[] = new FullProject("#58 / Fall '21 / 56 pages", "<em>Salvo</em> magazine", "images/sv58/", "cover.jpg", "mag-ad.jpg", "metamorphosis", 5, "social-justifying-the-means", 4, "still-looking-for-a-date", 4, "the-weasel-program", 4);
    $allProjects[] = new FullProject("#40 / Spring '17 / 64 pages", "<em>Salvo</em> magazine", "images/sv40/", "cover.jpg", "mag-ad.jpg", "meta-math", 4, "champ-change", 6, "remains-to-be-seen", 4, "", 0);
