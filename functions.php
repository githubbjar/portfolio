<?php
    ...
    //add the projects
    $allProjects[0] = new FullProject("#60 / Spring '22 / 64 pages", "<em>Salvo</em> magazine", "images/sv60/", "cover.jpg", "blog-ad.jpg", "what-the-wartortle", 5, "sun-in-a-million", 4, "i-ramona", 4, "i-porn", 2, "1");
    ...
    $allProjects[5] = new FullProject("#49 / Summer '19 / 64 pages", "<em>Salvo</em> magazine", "images/sv49/", "cover.jpg", "mag-ad.jpg", "far-and-away-above-average", 5, "dramatic-direction", 4, "overprotected", 4, "what-the-bleep", 4, "6");
    $allProjects[6] = new FullProject("Nov/Dec '22 / 64 pages", "<em>Touchstone</em> magazine", "images/ts356/", "cover.jpg", "cal-ad.jpg", "of-sages-and-prophets", 6, "old-school-beauty", 5, "a-thousand-words", 2, "commonplaces", 2, "7");
    $allProjects[7] = new FullProject("Jul/Aug '22 / 56 pages", "<em>Touchstone</em> magazine", "images/ts354/", "cover.jpg", "conf-ad.jpg", "the-sacred-cosmos", 6, "dominion", 4, "a-thousand-words", 2, "commonplaces", 2, "8");
    $allProjects[8] = new FullProject("Nov/Dec '22 / 56 pages", "<em>Touchstone</em> magazine", "images/ts346/", "cover.jpg", "cal-ad.jpg", "st-nicholas", 7, "john-paul-the-scribe", 5, "a-thousand-words", 2, "commonplaces", 2, "9");
    $allProjects[9] = new FullProject("Jul/Aug '20 / 56 pages", "<em>Touchstone</em> magazine", "images/ts334/", "cover.jpg", "share-ts.jpg", "no-option", 11, "book-reviews", 4, "a-thousand-words", 2, "commonplaces", 2, "10");
    $allProjects[10] = new FullProject("2022 Conference print/web", "<em>Touchstone</em> magazine", "images/tsconf/", "cover.jpg", "website.jpg", "program", 4, "postcard", 4, "slide", 2, "video", 2, "11");
    $allProjects[11] = new FullProject("Sept/Oct '19 / 56 pages", "<em>Touchstone</em> magazine", "images/ts325/", "cover.jpg", "share-ts.jpg", "looking-for-jacobs", 4, "make-men-pious-again", 4, "book-review", 2, "commonplaces", 2, "12");
    $allProjects[12] = new FullProject("5 Masses / sheet music", "Biretta Books", "images/bmass/", "cover.jpg", "mass-ad.jpg", "missa-yellow", 4, "miss-green", 4, "missa-brown", 2, "missa-light-green", 2, "13");
    $allProjects[13] = new FullProject("Schedule '23 / 16 pages", "Biretta Books", "images/bmusic23/", "cover.jpg", "back-cover.jpg", "first-group", 4, "second-group", 4, "third-group", 2, "fourth-group", 2, "14");
    $allProjects[14] = new FullProject("Ordo '23 book / 144 pages", "Biretta Books", "images/bordo23/", "cover.jpg", "back-cover.jpg", "first-group", 4, "second-group", 4, "third-group", 2, "fourth-group", 2, "15");
    $allProjects[15] = new FullProject("Newsletter / 16 pages", "Biretta Books", "images/bviasacra/", "cover.jpg", "back-cover.jpg", "first-group", 4, "second-group", 4, "third-group", 2, "fourth-group", 2, "16");
    $allProjects[16] = new FullProject("Program / 8 pages", "Biretta Books", "images/bmozart/", "cover.jpg", "back-cover.jpg", "first-group", 4, "second-group", 4, "third-group", 2, "fourth-group", 0, "17");
    $allProjects[17] = new FullProject("Ordo '22 book / 152 pages", "Biretta Books", "images/bordo22/", "cover.jpg", "back-cover.jpg", "first-group", 4, "second-group", 4, "third-group", 2, "fourth-group", 2, "18");
